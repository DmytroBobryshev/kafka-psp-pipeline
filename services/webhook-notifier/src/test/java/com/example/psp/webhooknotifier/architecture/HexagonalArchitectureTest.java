package com.example.psp.webhooknotifier.architecture;
...
class HexagonalArchitectureTest {
    ...
    @Test
    void domainMustNotDependOnPersistenceOrHttpFrameworks() {
        ArchRule rule =
                noClasses()
                        .that()
                        .resideInAPackage("..domain..")
                        ...
                        .because(
                                "domain/ must not depend on MongoDB or the HTTP client - both are adapter"
                                        + " concerns (ADR-0007)");
    ...
    void domainClassesShouldOnlyResideInDomainPackage() {
        ...
        ArchRule rule =
                classes()
                        .that()
                        .haveSimpleNameEndingWith("WebhookDeliveryCommand")
                        .or()
                        .haveSimpleNameEndingWith("RetryChain")
                        .or()
                        .haveSimpleNameEndingWith("RetryEnvelope")
                        .should()
                        .resideInAPackage("..domain..")
