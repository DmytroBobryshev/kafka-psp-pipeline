 ...
 *
 * @param causationEventId the inbound event's own {@code EventEnvelope.eventId} - becomes this
 *                          attempt's causation link when the outbound status event is published.
