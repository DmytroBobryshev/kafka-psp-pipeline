...
|---|---|---|---|---|
| `payment-api` | `psp.provider-status-reply.v1` (L), `payments.payment-status-changed.v1` (L), `refunds.refund-status-changed.v1` (L), `refunds.refund-completed.v1` (L), `refunds.refund-failed.v1` (L), `refunds.funds-reserved.v1` (L) | `merchants.merchant-config-changed.v1` (L), `psp.provider-status-query.v1` (L), `payments.payment-requested.v1` (L), `refunds.refund-requested.v1` (L), `payments.payment-status-changed.v1` (L), `disputes.dispute-opened.v1` (L) | `payment-api.replies.` (P), `payment-api.status-view.` (P), `payment-api.merchant-view.` (P), `payment-api.refund-` (P) | - |
| `psp-connector` | `payments.payment-requested.v1` (L), `refunds.funds-reserved.v1` (L), `psp.provider-status-query.v1` (L) | `payments.payment-status-changed.v1` (L), `refunds.refund-completed.v1` (L), `refunds.refund-failed.v1` (L), `refunds.refund-status-changed.v1` (L), `psp.provider-status-reply.v1` (L), `payments.payment-requested.v1.psp-connector.dlq` (L) | `psp-connector` (P) | - |
